...
public abstract class ThreadMgTransform implements AsmClassVisitorFactory<InstrumentationParameters.None> {
    ...
    public ClassVisitor createClassVisitor(@NotNull ClassContext classContext, @NotNull ClassVisitor classVisitor) {
        ...
        return new ClassVisitor(Opcodes.ASM5,classVisitor) {
            ...
            public MethodVisitor visitMethod(int access, String name, String descriptor, String signature, String[] exceptions) {
                ...
                return ThreadMgMethodVisitorCreator.getInstance().obtion(className, oldMethodVisitor, access, name, descriptor);
            }
        };
    }
