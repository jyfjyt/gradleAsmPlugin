...
import com.jyf.plugin.threadmg.ThreadMgTransform;
 ...
 */
public class ThreadMgPlugin implements Plugin<Project> {
    ...
    public void apply(Project project) {
        ...
        androidComponentsExtension.onVariants(releaseVariantSelector, variant -> {
             ...
             */
            variant.transformClassesWith(ThreadMgTransform.class ,InstrumentationScope.PROJECT, none -> null);
